    ...
    <aside id="service">
      ...
      <div class="container">
        <div class="row row-block txt1">
          <p>
            Автосервис <big>Mad Mechanics</big>  оказывает полный спектр услуг по ремонту любой сложности, диагностике и покраске автомобиля. 
          </p>
          <li>Главной задачей сервиса является быстрое и качественное обслуживание наших клиентов, поэтому мы предоставляем гарантии на производимые в нашем серисе работы.
          </li>
          <li>
                ...
                <div class="container">
                    ...
                    <div class="col-md-4 center">
                        ...
                        <p>
                            ...
                            мастера тполировали все быстро и аккуратно. Ничего не заметно! Спасибо! В следующий раз сразу к вам поеду!
                        </p>
                    </div>
                    <div class="col-md-4 center">
            ...
            <div id="contact_form" class="row opacity border">
              <div class="">
                ...
                <div class="left-block left-bg col-md-6">
                    ...
                    <br>
                    <p>Или просто оставте свои контактные данные.</p>
